...
if __name__ == "__main__":
    ...
    ga = GeneticAlgorithm(StringGene, StringEvaluator(target=target), RouletteSelector(), population_size=100, mutation_probability=.005, process_pool=process_pool, gene_length=len(target), output_dir='results/stringevolver/')
    ga.start()
