...
if __name__ == "__main__":
    # individual = pickle_load(open("results/first_run/st60ps250mp02.p", "rb"))
    individual = pickle_load(open("results/results_with_bias/best-generation-87.p", "rb"))

    gene: RNNGene = individual.gene

    # update the old saved genes to include weights for the bias node
    # gene.input_weights = append(gene.input_weights, [[0 for _ in range(gene.input_weights.shape[1])]], axis=0)
